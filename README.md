...
Este repositorio corresponde a una aplicación web para la gestión de una clínica veterinaria.  
El proyecto está dividido en ramas que representan diferentes componentes de la solución.  
Cada rama incluye su propio **README.md** explicando en detalle la función y características específicas de esa parte del sistema.
